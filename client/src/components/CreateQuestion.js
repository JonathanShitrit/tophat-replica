                        ...
                        switch (this.props.QuestionType) {
                            ...
                            case "TEXTBOX": return (
                                <div className="form-group">
                                    ...
                                    <input type="text" onChange={this.props.changeHandler} className="form-control" placeholder="Enter correct answer to question" name="TextboxAnswer" required />
                                </div>
                            )
                            // <Textbox changeHandler={this.props.changeHandler} />;
                            default: return;
                        }
                    })()}
...
const MultipleChoice = () => (
    <div>
        <div className="form-group">
            ...
            <input type="text" className="form-control choice" placeholder="Enter value" name="Choice" required />
            <div className="is-answer">
                <label htmlFor="1">Correct answer? </label>
                <input type="checkbox" id="1" className="isAnswerCheckbox" style={{ margin: "4px", verticalAlign: "middle" }} name="IsAnswer" />
            </div>
        </div>
        <div className="form-group">
            ...
            <div className="is-answer">
                ...
                <input type="checkbox" id="2" className="isAnswerCheckbox" style={{ margin: "4px", verticalAlign: "middle" }} name="IsAnswer" />
            </div>
        </div>
        <div className="form-group">
            ...
            <div className="is-answer">
                ...
                <input type="checkbox" id="3" className="isAnswerCheckbox" style={{ margin: "4px", verticalAlign: "middle" }} name="IsAnswer" />
            </div>
        </div>
        <div className="form-group">
            ...
            <div className="is-answer">
                ...
                <input type="checkbox" id="4" className="isAnswerCheckbox" style={{ margin: "4px", verticalAlign: "middle" }} name="IsAnswer" />
            </div>
        </div>
        <div className="form-group">
            ...
            <div className="is-answer">
                ...
                <input type="checkbox" id="5" className="isAnswerCheckbox" style={{ margin: "4px", verticalAlign: "middle" }} name="IsAnswer" />
            </div>
        </div>
    </div>
)
